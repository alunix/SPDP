...
class PermohonanController extends Controller
{
    ...
    {
        $id = auth()->user()->id;
        // $permohonans = Permohonan::with(['jenis_permohonan', 'dokumen_permohonans', 'user','status_permohonan'])->where('id_penghantar', $id)->get();
        $permohonans = Permohonan::with(['jenis_permohonan', 'dokumen_permohonans', 'user','status_permohonan'])->where('id_penghantar', $id)->paginate(10);
