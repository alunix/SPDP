 ...
 
{
    ...
    //  $line_chart->dataset('Dokumen permohonan', 'line',$dokumens->pluck('count'))->options([
    //      'backgroundColor'=> ['#C5CAE9', '#283593']
    //      ,'dimensions'=>[500,500]
    //  ]);
    ...
    //  $pie_chart->dataset('Jenis permohonan tahun '.$year, 'pie',$permohonans->pluck('count'))->color(['#3366CC','#DC3912','#FF9900','#109618','#990099','#3B3EAC','#0099C6','#DD4477'])->options([
    //     'colorCount'=>10,'dimensions'=>[800,800]
    //  ]);
    ...
    //  return view ('dashboard.fakulti-dashboard')->with('dokumen_permohonans',$dokumens)->with('permohonans',$permohonans)->with('line_chart',$line_chart)->with('pie_chart',$pie_chart)->with('permohonan_in_progress', $progress)->with('permohonan_diluluskan',$lulus);
