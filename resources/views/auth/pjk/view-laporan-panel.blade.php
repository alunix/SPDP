    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card-body">
                        ...
                        @csrf
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="penilaian_id" type="text" value="{{ @$penilaian['id'] }}"  class="form-control" name="penilaian_id"  required autofocus readonly>
                        ...
                        <div class="form-group row">
                             <label for="laporan_panel_link" class="col-md-4 col-form-label text-md-right">{{ __('Laporan Panel Penilai') }}</label>
