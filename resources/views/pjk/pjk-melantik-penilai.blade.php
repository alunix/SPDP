    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card-body">
                     ...
                     <form class="form-prevent-double-submits" method="POST" action="{{ route('pelantikan_penilai.submit',['permohonan' => $permohonan->permohonan_id])}}"  enctype="multipart/form-data" >
                     {!! method_field('patch') !!}                 
